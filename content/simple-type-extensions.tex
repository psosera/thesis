...
\begin{lemma}[Satisfication Preservation of $\mfun{proj}$]
...
We apply \rulename{irefine-sum-inr} because all the examples agree that the synthesized program should be $\mfalse$.
