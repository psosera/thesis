...
In \autoref{ch:the-future-of-program-synthesis-with-types}, we briefly explore how we can use this partial program information to reduce the number of examples we need to provide to the synthesizer.
