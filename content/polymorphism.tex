...
We start our exploration with System F~\todo{cite---Girard 1972}, the simply-typed lambda calculus extended with universal quantification.
...
To do this, we introduce \emphs{boxed polymorphic expression}, written $\pbox{e}{α}$, that records that a particular expression ought to be treated as if had type $α$.
...
We close our brief discussion of polymorphism by stating the necessary lemmas for soundness and completeness of \systemfsyn{}.
