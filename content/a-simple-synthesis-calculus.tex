...
In proof search, this syntax is useful for generating normal form proofs which, by the Curry-Howard Isomorphism~\todo{cite---Howard's ``The Formulae-as-types Notion of Construction''}, is equivalent to generating normal form programs in our setting.
Dividing the syntax in this manner also facilities a description \emph{bidirectional type checking}~\todo{cite---Pierce and Turner 2000} where we explicitly state when a type is an input or output in the type checking judgment.
...
Specification can take many forms, for example, logical properties~\todo{cite---Sketch and Others} or execution traces~\todo{cite---Programming by Demonstration work}.
...
In particular, $E$ and $I$ terms are checked in a bidirectional type checking style~\todo{cite---Pierce and Turner 2000}.
