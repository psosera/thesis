...
Constants $c_k$ all have type $T$ (\rulename{t-ex-base}), and a partial function $\many{v_i ⇒ χ_i}{i < m}$ has type $τ_1 → τ_2$ if all of the $v_i$ have type $τ_1$ and all of the $χ_i$ have type $τ_2$ (\rulename{t-ex-pf}).
...
However, in~\autoref{ch:recursion}, we explore changes to \rulename{irefine-arr} that make this fact no longer true.
