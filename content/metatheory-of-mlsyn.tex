...
\todo{%
  Also talk about consistency detection and how it is not possible in \mlsyn{} because we have lost completeness.
  The discussion should complement the consistency discussion we eventually put in \autoref{ch:metatheory-of-lsyn}.
}
