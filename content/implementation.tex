...
In our collection semantics, this implies that we must first generate such a match via $\mfmatch$ and then generate the application through $\mgen$ or constructor through $\mrefine$ rather than the other way around.
...
\begin{center}
  ...
  \end{forest}
\end{center}
We can make no further progress because the examples at the \rulename{irefine-arr} node do not share the same head constructor, and we are not allowed to introduce matches as the match depth is zero.
