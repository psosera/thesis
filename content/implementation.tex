...
\end{definition}
The Minimum Program Principle is not a provable theorem, but a search heuristic exploited by many program synthesis tools (\todo{cite---all the example-based synthesis systems that employ this principle.}) to refine the space of programs even further.
...
Inspired by relevance logic \todo{cite---Anderson, Belnap, and Dunn}, these functions are variants of our standard term-enumeration functions except that they require that all expressions they generate must contain the relevant variable $x$.
